...
A3  
 ...
 B3  
 a. Can you model a dolphin that swims without inheriting from a fish class? -> **Yes just don't extend  
  Fish class**   
 b. How do you avoid duplicating code or introducing unneeded overhead? -> **By using interfaces, it can  
 have different implementation on different classes**
